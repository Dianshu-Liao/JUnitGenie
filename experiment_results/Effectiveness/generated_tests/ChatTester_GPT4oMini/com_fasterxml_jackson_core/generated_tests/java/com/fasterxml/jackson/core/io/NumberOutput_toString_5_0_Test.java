...
public class NumberOutput_toString_5_0_Test {
    ...
    @Test
    public void testToString_PositiveSmallValues() throws Exception {
    ...
    @Test
    public void testToString_NegativeSmallValues() throws Exception {
        assertEquals("-1", invokeToString(-1));
        assertEquals("-2", invokeToString(-2));
        assertEquals("-3", invokeToString(-3));
        assertEquals("-4", invokeToString(-4));
    ...
    @Test
    public void testToString_LargeValues() throws Exception {
        assertEquals("11", invokeToString(11));
    ...
    @Test
    public void testToString_AdditionalCases() throws Exception {
        assertEquals("1000000", invokeToString(1000000));
        assertEquals("1000000000", invokeToString(1000000000));
        assertEquals("-1000000", invokeToString(-1000000));
        assertEquals("-1000000000", invokeToString(-1000000000));
    }
