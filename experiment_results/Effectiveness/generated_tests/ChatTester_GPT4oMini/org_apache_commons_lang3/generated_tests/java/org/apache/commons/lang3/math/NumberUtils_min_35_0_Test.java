...
public class NumberUtils_min_35_0_Test {
    ...
    public void testMinWithPositiveNumbers() {
        float result = NumberUtils.min(3.5f, 2.5f, 4.0f);
        assertEquals(2.5f, result);
    }

    @Test
    public void testMinWithNegativeNumbers() {
        float result = NumberUtils.min(-1.0f, -3.0f, -2.0f);
        assertEquals(-3.0f, result);
    }

    @Test
    public void testMinWithMixedNumbers() {
        float result = NumberUtils.min(-1.0f, 0.0f, 1.0f);
        assertEquals(-1.0f, result);
    }

    @Test
    public void testMinWithAllEqualNumbers() {
        float result = NumberUtils.min(2.0f, 2.0f, 2.0f);
