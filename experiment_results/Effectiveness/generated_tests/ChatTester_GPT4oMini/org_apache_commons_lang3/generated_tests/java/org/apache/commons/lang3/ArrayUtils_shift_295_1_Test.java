...
public class ArrayUtils_shift_295_1_Test {
    ...
    @Test
    public void testShift_ShiftWithPositiveOffset() {
    ...
    @Test
    public void testShift_ShiftWithNegativeOffset() {
        Object[] array = { 1, 2, 3, 4, 5 };
        ArrayUtils.shift(array, 0, 5, -2);
    ...
    @Test
    public void testShift_OffsetLessThanNegativeLength() {
        Object[] array = { 1, 2, 3, 4, 5 };
        ArrayUtils.shift(array, 0, 5, -6);
        assertArrayEquals(new Object[] { 2, 3, 4, 5, 1 }, array);
    }

    @Test
    public void testShift_ValidRangeOutOfBounds() {
        Object[] array = { 1, 2, 3, 4, 5 };
        ArrayUtils.shift(array, 1, 3, 1);
        assertArrayEquals(new Object[] { 1, 3, 2, 4, 5 }, array);
    }

    @Test
    public void testShift_StartIndexOutOfBounds() {
        Object[] array = { 1, 2, 3, 4, 5 };
        ArrayUtils.shift(array, 5, 5, 1);
        assertArrayEquals(array, new Object[] { 1, 2, 3, 4, 5 });
    }

    @Test
    public void testShift_EndIndexOutOfBounds() {
        Object[] array = { 1, 2, 3, 4, 5 };
        ArrayUtils.shift(array, 0, 10, 1);
    ...
    @Test
    public void testShift_NegativeOffsetWithValidRange() {
        Object[] array = { 1, 2, 3, 4, 5 };
        ArrayUtils.shift(array, 1, 4, -1);
        assertArrayEquals(new Object[] { 1, 4, 2, 3, 5 }, array);
    }
}
