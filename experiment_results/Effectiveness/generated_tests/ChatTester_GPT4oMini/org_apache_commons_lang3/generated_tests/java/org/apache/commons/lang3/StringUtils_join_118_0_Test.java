...
public class StringUtils_join_118_0_Test {
    ...
    @Test
    public void testJoin_withMultipleElements() {
    ...
    @Test
    public void testJoin_withAllNullElements() {
        String result = StringUtils.join((String) null, (String) null);
        assertEquals("", result);
    }

    @Test
    public void testJoin_withMixedTypes() {
        String result = StringUtils.join(1, 2, 3);
        assertEquals("123", result);
    }

    @Test
    public void testJoin_withEmptyStringElements() {
        String result = StringUtils.join("", "", "");
        assertEquals("", result);
    }

    @Test
    public void testJoin_withSpecialCharacters() {
        String result = StringUtils.join("Hello", "@", "#", "$");
        assertEquals("Hello@#$", result);
    }

    @Test
    public void testJoin_withWhitespaceElements() {
        String result = StringUtils.join(" ", " ", " ");
        assertEquals("   ", result);
    }
}
