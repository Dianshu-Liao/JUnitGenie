...
public class ZipArchiveEntry_addInfoZipExtendedTimestamp_7_0_Test {
    ...
    @Test
    public void testAddInfoZipExtendedTimestampWithAllTimestamps() throws Exception {
        ...
        // Verify that the internalAddExtraField method was called with the correct X5455_ExtendedTimestamp
        // This requires you to have a way to access the internal state or to mock the behavior.
        // Assuming there's a way to verify that the extra field was added correctly.
        // For example, if you have a method to retrieve the extra fields:
    ...
    @Test
    public void testAddInfoZipExtendedTimestampWithNullLastModifiedTime() throws Exception {
        FileTime lastAccessTime = FileTime.fromMillis(System.currentTimeMillis());
        FileTime creationTime = FileTime.fromMillis(System.currentTimeMillis());
        invokeAddInfoZipExtendedTimestamp(null, lastAccessTime, creationTime);
        ZipExtraField[] extraFields = zipArchiveEntry.getExtraFields();
        assertNotNull(extraFields);
        assertEquals(1, extraFields.length);
        X5455_ExtendedTimestamp timestamp = (X5455_ExtendedTimestamp) extraFields[0];
    ...
    @Test
    public void testAddInfoZipExtendedTimestampWithNullLastAccessTime() throws Exception {
        FileTime lastModifiedTime = FileTime.fromMillis(System.currentTimeMillis());
        FileTime creationTime = FileTime.fromMillis(System.currentTimeMillis());
    ...
    @Test
    public void testAddInfoZipExtendedTimestampWithNullCreationTime() throws Exception {
        FileTime lastModifiedTime = FileTime.fromMillis(System.currentTimeMillis());
        FileTime lastAccessTime = FileTime.fromMillis(System.currentTimeMillis());
