...
class DefaultXmlPrettyPrinter_writeLeafElement_19_4_Test {
    ...
    void testWriteLeafElement_WithIndentation() throws XMLStreamException {
        ...
        // Act
        prettyPrinter.writeLeafElement(mockWriter, "http://example.com", "element", 42);
        // Assert
    ...
    void testWriteLeafElement_WithoutIndentation() throws XMLStreamException {
        ...
        // Act
        prettyPrinter.writeLeafElement(mockWriter, "http://example.com", "element", 42);
        // Fixed line: using the correct method signature
