...
public class format_DataFormatMatcher_getMatchedFormatName__ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(format_DataFormatMatcher_getMatchedFormatName__ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Enumeration", false, format_DataFormatMatcher_getMatchedFormatName__ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(format_DataFormatMatcher_getMatchedFormatName__ESTest_scaffolding.class.getClassLoader()); 
