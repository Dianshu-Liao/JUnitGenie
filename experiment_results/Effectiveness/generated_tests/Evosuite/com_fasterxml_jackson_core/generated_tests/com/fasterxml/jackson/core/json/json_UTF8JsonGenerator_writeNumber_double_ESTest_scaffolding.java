...
public class json_UTF8JsonGenerator_writeNumber_double_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(json_UTF8JsonGenerator_writeNumber_double_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.core.ErrorReportConfiguration", false, json_UTF8JsonGenerator_writeNumber_double_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.ObjectCodec", false, json_UTF8JsonGenerator_writeNumber_double_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.StreamReadConstraints", false, json_UTF8JsonGenerator_writeNumber_double_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.io.ContentReference", false, json_UTF8JsonGenerator_writeNumber_double_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(json_UTF8JsonGenerator_writeNumber_double_ESTest_scaffolding.class.getClassLoader()); 
