...
public class base_GeneratorBase_setFeatureMask_int_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(base_GeneratorBase_setFeatureMask_int_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.core.ErrorReportConfiguration", false, base_GeneratorBase_setFeatureMask_int_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.ObjectCodec", false, base_GeneratorBase_setFeatureMask_int_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.StreamReadConstraints", false, base_GeneratorBase_setFeatureMask_int_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.StreamWriteConstraints", false, base_GeneratorBase_setFeatureMask_int_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.io.ContentReference", false, base_GeneratorBase_setFeatureMask_int_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(base_GeneratorBase_setFeatureMask_int_ESTest_scaffolding.class.getClassLoader()); 
