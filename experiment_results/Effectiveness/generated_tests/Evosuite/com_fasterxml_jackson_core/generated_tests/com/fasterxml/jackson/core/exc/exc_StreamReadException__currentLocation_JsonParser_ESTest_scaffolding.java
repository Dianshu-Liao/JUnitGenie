...
public class exc_StreamReadException__currentLocation_JsonParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.fasterxml.jackson.core.exc.StreamReadException"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(exc_StreamReadException__currentLocation_JsonParser_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(exc_StreamReadException__currentLocation_JsonParser_ESTest_scaffolding.class.getClassLoader()); 
