...
public class base_ParserBase_getLongValue__ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(base_ParserBase_getLongValue__ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.core.ObjectCodec", false, base_ParserBase_getLongValue__ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.StreamWriteConstraints", false, base_ParserBase_getLongValue__ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.io.ContentReference", false, base_ParserBase_getLongValue__ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer", false, base_ParserBase_getLongValue__ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(base_ParserBase_getLongValue__ESTest_scaffolding.class.getClassLoader()); 
