...
public class JsonParser_nextFieldName_SerializableString_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(JsonParser_nextFieldName_SerializableString_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.core.ObjectCodec", false, JsonParser_nextFieldName_SerializableString_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.io.ContentReference", false, JsonParser_nextFieldName_SerializableString_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.fasterxml.jackson.core.sym.ByteQuadsCanonicalizer", false, JsonParser_nextFieldName_SerializableString_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Enumeration", false, JsonParser_nextFieldName_SerializableString_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(JsonParser_nextFieldName_SerializableString_ESTest_scaffolding.class.getClassLoader()); 
