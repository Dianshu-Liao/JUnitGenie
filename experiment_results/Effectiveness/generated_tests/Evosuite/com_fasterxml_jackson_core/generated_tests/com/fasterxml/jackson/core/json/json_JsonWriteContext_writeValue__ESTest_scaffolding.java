...
public class json_JsonWriteContext_writeValue__ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(json_JsonWriteContext_writeValue__ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.fasterxml.jackson.core.json.DupDetector", false, json_JsonWriteContext_writeValue__ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(json_JsonWriteContext_writeValue__ESTest_scaffolding.class.getClassLoader()); 
