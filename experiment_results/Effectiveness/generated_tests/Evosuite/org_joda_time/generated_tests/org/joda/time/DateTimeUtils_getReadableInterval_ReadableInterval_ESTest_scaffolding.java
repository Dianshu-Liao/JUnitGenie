...
public class DateTimeUtils_getReadableInterval_ReadableInterval_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DateTimeUtils_getReadableInterval_ReadableInterval_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.Chronology", false, DateTimeUtils_getReadableInterval_ReadableInterval_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DateTimeUtils_getReadableInterval_ReadableInterval_ESTest_scaffolding.class.getClassLoader()); 
