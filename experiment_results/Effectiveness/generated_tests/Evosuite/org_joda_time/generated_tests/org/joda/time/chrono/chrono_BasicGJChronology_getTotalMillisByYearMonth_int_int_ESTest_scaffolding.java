...
public class chrono_BasicGJChronology_getTotalMillisByYearMonth_int_int_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(chrono_BasicGJChronology_getTotalMillisByYearMonth_int_int_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.Chronology", false, chrono_BasicGJChronology_getTotalMillisByYearMonth_int_int_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.DateTimeField", false, chrono_BasicGJChronology_getTotalMillisByYearMonth_int_int_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.DurationField", false, chrono_BasicGJChronology_getTotalMillisByYearMonth_int_int_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(chrono_BasicGJChronology_getTotalMillisByYearMonth_int_int_ESTest_scaffolding.class.getClassLoader()); 
