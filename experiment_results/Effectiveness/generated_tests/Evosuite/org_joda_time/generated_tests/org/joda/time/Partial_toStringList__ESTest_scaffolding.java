...
public class Partial_toStringList__ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Partial_toStringList__ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.Chronology", false, Partial_toStringList__ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.DateTimeFieldType", false, Partial_toStringList__ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Partial_toStringList__ESTest_scaffolding.class.getClassLoader()); 
