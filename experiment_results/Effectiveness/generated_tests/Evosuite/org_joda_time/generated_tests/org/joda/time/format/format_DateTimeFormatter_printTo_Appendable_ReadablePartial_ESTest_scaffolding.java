...
public class format_DateTimeFormatter_printTo_Appendable_ReadablePartial_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(format_DateTimeFormatter_printTo_Appendable_ReadablePartial_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.Chronology", false, format_DateTimeFormatter_printTo_Appendable_ReadablePartial_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.DateTimeFieldType", false, format_DateTimeFormatter_printTo_Appendable_ReadablePartial_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.format.DateTimeParser", false, format_DateTimeFormatter_printTo_Appendable_ReadablePartial_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.format.DateTimePrinter", false, format_DateTimeFormatter_printTo_Appendable_ReadablePartial_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(format_DateTimeFormatter_printTo_Appendable_ReadablePartial_ESTest_scaffolding.class.getClassLoader()); 
