...
public class DateTimeUtils_isContiguous_ReadablePartial_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DateTimeUtils_isContiguous_ReadablePartial_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.Chronology", false, DateTimeUtils_isContiguous_ReadablePartial_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.DateTimeField", false, DateTimeUtils_isContiguous_ReadablePartial_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.DurationField", false, DateTimeUtils_isContiguous_ReadablePartial_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.DurationFieldType", false, DateTimeUtils_isContiguous_ReadablePartial_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DateTimeUtils_isContiguous_ReadablePartial_ESTest_scaffolding.class.getClassLoader()); 
