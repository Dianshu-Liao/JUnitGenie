...
public class base_AbstractPeriod_get_DurationFieldType_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(base_AbstractPeriod_get_DurationFieldType_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.Chronology", false, base_AbstractPeriod_get_DurationFieldType_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.DurationFieldType", false, base_AbstractPeriod_get_DurationFieldType_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.PeriodType", false, base_AbstractPeriod_get_DurationFieldType_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(base_AbstractPeriod_get_DurationFieldType_ESTest_scaffolding.class.getClassLoader()); 
