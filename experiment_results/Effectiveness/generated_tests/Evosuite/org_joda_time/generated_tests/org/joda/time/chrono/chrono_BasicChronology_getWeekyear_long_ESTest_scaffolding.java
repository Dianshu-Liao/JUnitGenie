...
public class chrono_BasicChronology_getWeekyear_long_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(chrono_BasicChronology_getWeekyear_long_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.Chronology", false, chrono_BasicChronology_getWeekyear_long_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(chrono_BasicChronology_getWeekyear_long_ESTest_scaffolding.class.getClassLoader()); 
