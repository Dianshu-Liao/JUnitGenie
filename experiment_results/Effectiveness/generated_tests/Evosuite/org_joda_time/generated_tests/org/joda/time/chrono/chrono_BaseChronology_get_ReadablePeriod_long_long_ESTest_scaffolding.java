...
public class chrono_BaseChronology_get_ReadablePeriod_long_long_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(chrono_BaseChronology_get_ReadablePeriod_long_long_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.Chronology", false, chrono_BaseChronology_get_ReadablePeriod_long_long_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.DurationField", false, chrono_BaseChronology_get_ReadablePeriod_long_long_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(chrono_BaseChronology_get_ReadablePeriod_long_long_ESTest_scaffolding.class.getClassLoader()); 
