...
public class ThreadUtils_findThreadById_long_ThreadGroup_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ThreadUtils_findThreadById_long_ThreadGroup_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.lang.ThreadGroup", false, ThreadUtils_findThreadById_long_ThreadGroup_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ThreadUtils_findThreadById_long_ThreadGroup_ESTest_scaffolding.class.getClassLoader()); 
