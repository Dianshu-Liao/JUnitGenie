...
public class CollectionUtils_collect_Iterable_Transformer_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CollectionUtils_collect_Iterable_Transformer_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.apache.commons.collections4.Transformer", false, CollectionUtils_collect_Iterable_Transformer_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CollectionUtils_collect_Iterable_Transformer_ESTest_scaffolding.class.getClassLoader()); 
