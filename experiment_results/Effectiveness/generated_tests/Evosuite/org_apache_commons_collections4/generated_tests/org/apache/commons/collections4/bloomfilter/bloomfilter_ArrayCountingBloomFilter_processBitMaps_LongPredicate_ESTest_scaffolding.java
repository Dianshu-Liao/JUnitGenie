...
public class bloomfilter_ArrayCountingBloomFilter_processBitMaps_LongPredicate_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(bloomfilter_ArrayCountingBloomFilter_processBitMaps_LongPredicate_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.apache.commons.collections4.bloomfilter.LongBiPredicate", false, bloomfilter_ArrayCountingBloomFilter_processBitMaps_LongPredicate_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.collections4.bloomfilter.Shape", false, bloomfilter_ArrayCountingBloomFilter_processBitMaps_LongPredicate_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(bloomfilter_ArrayCountingBloomFilter_processBitMaps_LongPredicate_ESTest_scaffolding.class.getClassLoader()); 
