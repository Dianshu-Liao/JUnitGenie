...
public class bag_AbstractBagDecorator_equals_Object_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(bag_AbstractBagDecorator_equals_Object_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Comparator", false, bag_AbstractBagDecorator_equals_Object_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(bag_AbstractBagDecorator_equals_Object_ESTest_scaffolding.class.getClassLoader()); 
