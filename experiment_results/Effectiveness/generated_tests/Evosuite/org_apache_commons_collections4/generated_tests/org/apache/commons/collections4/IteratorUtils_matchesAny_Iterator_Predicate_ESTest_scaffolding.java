...
public class IteratorUtils_matchesAny_Iterator_Predicate_ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(IteratorUtils_matchesAny_Iterator_Predicate_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.apache.commons.collections4.Predicate", false, IteratorUtils_matchesAny_Iterator_Predicate_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(IteratorUtils_matchesAny_Iterator_Predicate_ESTest_scaffolding.class.getClassLoader()); 
