...
public class bloomfilter_SimpleBloomFilter_cardinality__ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(bloomfilter_SimpleBloomFilter_cardinality__ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.apache.commons.collections4.bloomfilter.Shape", false, bloomfilter_SimpleBloomFilter_cardinality__ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(bloomfilter_SimpleBloomFilter_cardinality__ESTest_scaffolding.class.getClassLoader()); 
