...
public class list_AbstractLinkedList_toString__ESTest_scaffolding {
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(list_AbstractLinkedList_toString__ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.apache.commons.collections4.list.AbstractLinkedList", false, list_AbstractLinkedList_toString__ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(list_AbstractLinkedList_toString__ESTest_scaffolding.class.getClassLoader()); 
