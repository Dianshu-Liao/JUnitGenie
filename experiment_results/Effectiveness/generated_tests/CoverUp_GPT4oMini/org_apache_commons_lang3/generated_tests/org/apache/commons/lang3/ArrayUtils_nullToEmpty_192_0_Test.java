...
public class ArrayUtils_nullToEmpty_192_0_Test {
    ...
    public void testNullToEmpty() {
        ...
        Float[] input = null;
        Float[] expected = ArrayUtils.EMPTY_FLOAT_OBJECT_ARRAY;
        Float[] result = ArrayUtils.nullToEmpty(input);
        assertArrayEquals(expected, result);
        // Test case where input is an empty array
        input = new Float[0];
        expected = ArrayUtils.EMPTY_FLOAT_OBJECT_ARRAY;
        result = ArrayUtils.nullToEmpty(input);
        assertArrayEquals(expected, result);
        // Test case where input is a non-empty array
