...
public class StringUtils_center_9_0_Test {
    ...
    @Test
    public void testCenter_OddSize() throws Exception {
        String result = invokeCenterMethod("test", 9, '*');
        assertEquals("***test***", result);
    }

    @Test
    public void testCenter_EvenSize() throws Exception {
        String result = invokeCenterMethod("test", 10, '*');
        assertEquals("**test****", result);
    }

    @Test
    public void testCenter_SpacePadding() throws Exception {
        String result = invokeCenterMethod("test", 12, ' ');
        assertEquals("   test    ", result);
    }
