...
public class ArrayUtils_nullToEmpty_187_0_Test {
    ...
    private Character[] invokeNullToEmpty(Character[] array) throws Exception {
        Method method = ArrayUtils.class.getDeclaredMethod("nullToEmpty", Character[].class);
        method.setAccessible(true);
        return (Character[]) method.invoke(arrayUtils, (Object) array);
    }
}
