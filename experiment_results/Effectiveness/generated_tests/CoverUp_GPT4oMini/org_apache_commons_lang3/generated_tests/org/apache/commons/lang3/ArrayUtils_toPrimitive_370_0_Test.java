...
public class ArrayUtils_toPrimitive_370_0_Test {
    ...
    public void testToPrimitive_ArrayWithNulls() {
        ...
        short[] result = ArrayUtils.toPrimitive(input, valueForNull);
        // Assert
        assertArrayEquals(new short[] { 1, 0, 3 }, result);
    }
    ...
    public void testToPrimitive_MixedArray() {
        // Arrange
        Short[] input = { null, 2, null, 4 };
        short valueForNull = 5;
        // Act
        short[] result = ArrayUtils.toPrimitive(input, valueForNull);
        // Assert
        assertArrayEquals(new short[] { 5, 2, 5, 4 }, result);
    }
}
