...
public class StringUtils_substringAfter_211_0_Test {
    ...
    @Test
    public void testSubstringAfter_WithValidInput() {
        String result = StringUtils.substringAfter("hello world", " ");
        assertEquals("world", result);
    }

    @Test
    public void testSubstringAfter_WithNoSeparator() {
        String result = StringUtils.substringAfter("hello world", ",");
    ...
    public void testSubstringAfter_WithEmptyString() {
        String result = StringUtils.substringAfter(StringUtils.EMPTY, " ");
        assertEquals(StringUtils.EMPTY, result);
    }
    ...
    public void testSubstringAfter_WithMultipleSeparators() {
        String result = StringUtils.substringAfter("hello world hello", "hello");
