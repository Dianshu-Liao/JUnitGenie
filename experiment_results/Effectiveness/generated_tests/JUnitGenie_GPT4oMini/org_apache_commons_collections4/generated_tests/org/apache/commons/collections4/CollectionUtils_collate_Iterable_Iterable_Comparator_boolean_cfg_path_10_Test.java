...
public class CollectionUtils_collate_Iterable_Iterable_Comparator_boolean_cfg_path_10_Test {

    @Test(timeout = 4000)
    public void testCollateWithCollectionsAndDuplicates() {
    ...
    @Test(timeout = 4000)
    public void testCollateWithCollectionsWithoutDuplicates() {
        List<Integer> iterableA = Arrays.asList(1, 2, 2, 3);
        List<Integer> iterableB = Arrays.asList(2, 3, 4);
        Comparator<Integer> comparator = Integer::compareTo;
