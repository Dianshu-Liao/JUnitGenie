...
public class sequence_SequencesComparator_buildSnake_int_int_int_int_cfg_path_6_Test {
    ...
    public void testBuildSnake() {
        ...
        // Create the necessary sequences and equator
        List<Object> sequence1 = Arrays.asList("A", "B", "C", "D", "E");
        List<Object> sequence2 = Arrays.asList("A", "B", "C", "D", "E");
