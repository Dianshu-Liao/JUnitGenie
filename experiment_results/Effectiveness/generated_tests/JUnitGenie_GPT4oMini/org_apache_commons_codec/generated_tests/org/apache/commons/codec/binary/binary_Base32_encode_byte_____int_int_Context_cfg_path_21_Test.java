...
public class binary_Base32_encode_byte_____int_int_Context_cfg_path_21_Test {
    ...
    public void testEncodeWithEOF() {
        ...
        try {
            ...
            fail("Exception should not have been thrown for EOF");
        }
    }
    ...
    public void testEncodeWithNegativeInAvail() {
        ...
        try {
            ...
            fail("Exception should not have been thrown for negative inAvail");
        }
    }
