...
public class ri_model_dynabeans_DynaBeanPointer_equals_Object_cfg_path_14_Test {
    ...
    @Test(timeout = 4000)
    public void testEquals_DifferentDynaBeanPointers() {
    ...
    @Test(timeout = 4000)
    public void testEquals_SameDynaBeanPointers() {
