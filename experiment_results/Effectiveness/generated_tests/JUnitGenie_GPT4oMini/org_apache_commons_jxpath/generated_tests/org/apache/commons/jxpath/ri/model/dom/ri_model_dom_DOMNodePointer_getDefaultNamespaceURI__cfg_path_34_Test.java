...
public class ri_model_dom_DOMNodePointer_getDefaultNamespaceURI__cfg_path_34_Test {
    ...
    public void testGetDefaultNamespaceURIWithElementNode() {
        try {
            ...
            DOMNodePointer pointer = new DOMNodePointer(mockDocument.getDocumentElement(), null);
