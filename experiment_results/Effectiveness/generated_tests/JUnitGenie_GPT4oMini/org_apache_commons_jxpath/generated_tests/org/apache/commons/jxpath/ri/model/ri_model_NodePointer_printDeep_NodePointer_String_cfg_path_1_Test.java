...
public class ri_model_NodePointer_printDeep_NodePointer_String_cfg_path_1_Test {
    ...
    private static class TestNodePointer extends NodePointer {
        ...
        public NodePointer getImmediateParentPointer() {
            return parent; // Return the parent for testing
        }
    }
    ...
    public void testPrintDeep() {
        try {
            ...
            // Call the method with the child pointer and an empty indent
            method.invoke(null, childPointer, "");

            // Call the method with the child pointer and a non-empty indent
            method.invoke(null, childPointer, "  ");
        } catch (Exception e) {
            e.printStackTrace();
