...
public class ri_model_jdom_JDOMAttributePointer_equals_Object_cfg_path_3_Test {
    ...
    public void testEquals_SameAttributes() {
        JDOMAttributePointer pointer1 = new JDOMAttributePointer(null, new Attribute("attr1", "value1", Namespace.NO_NAMESPACE));
        JDOMAttributePointer pointer2 = new JDOMAttributePointer(null, new Attribute("attr1", "value1", Namespace.NO_NAMESPACE));
