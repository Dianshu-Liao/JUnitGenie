...
public class ri_model_beans_BeanAttributeIterator__init__PropertyOwnerPointer_QName_cfg_path_12_Test {
    ...
    @Test(timeout = 4000)
    public void testBeanAttributeIteratorWithValidQName() {
        try {
    ...
    public void testBeanAttributeIteratorWithNullName() {
        try {
            QName name = new QName("testPrefix", null);
            PropertyOwnerPointer parent = new TestPropertyOwnerPointer(null);
            BeanAttributeIterator iterator = new BeanAttributeIterator(parent, name);
            assertNotNull(iterator);
        } catch (Exception e) {
    ...
    public void testBeanAttributeIteratorWithNullPrefix() {
        try {
            QName name = new QName(null, "testName");
            PropertyOwnerPointer parent = new TestPropertyOwnerPointer(null);
            BeanAttributeIterator iterator = new BeanAttributeIterator(parent, name);
            assertNotNull(iterator);
        } catch (Exception e) {
    ...
    public void testBeanAttributeIteratorWithWildcardName() {
        try {
            QName name = new QName("testPrefix", "*");
            PropertyOwnerPointer parent = new TestPropertyOwnerPointer(null);
            BeanAttributeIterator iterator = new BeanAttributeIterator(parent, name);
            assertNotNull(iterator);
        } catch (Exception e) {
