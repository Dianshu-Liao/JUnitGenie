...
public class ri_JXPathContextReferenceImpl_allocateConditionally_String_String_cfg_path_11_Test {
    ...
    public void testAllocateConditionallyThrowsException() {
        ...
        try {
            ...
            assertTrue(ex.getMessage().contains("Cannot allocate " + className));
        }
    }
