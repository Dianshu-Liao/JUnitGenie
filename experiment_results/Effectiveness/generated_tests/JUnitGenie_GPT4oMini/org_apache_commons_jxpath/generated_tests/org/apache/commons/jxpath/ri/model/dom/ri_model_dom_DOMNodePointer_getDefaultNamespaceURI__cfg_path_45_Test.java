...
public class ri_model_dom_DOMNodePointer_getDefaultNamespaceURI__cfg_path_45_Test {
    ...
    public void testGetDefaultNamespaceURIWithElementNode() {
        try {
            ...
            DOMNodePointer pointer = new DOMNodePointer(mockDocument.getDocumentElement(), Locale.getDefault());
