...
public class util_ValueUtils_setValue_Object_PropertyDescriptor_Object_cfg_path_6_Test {
    ...
    public void testSetValueWithNullBean() {
        try {
            // Setup
            TestBean bean = null; // Change Object to TestBean
            PropertyDescriptor propertyDescriptor = new PropertyDescriptor("property", TestBean.class);
            Object value = "newValue";

            // Execute
            ValueUtils.setValue(bean, propertyDescriptor, value);
            fail("JXPathException should have been thrown");
    ...
    public void testSetValueWithNoWriteMethod() {
        try {
            // Setup
            TestBeanWithoutWriteMethod bean = new TestBeanWithoutWriteMethod(); // Change Object to TestBeanWithoutWriteMethod
