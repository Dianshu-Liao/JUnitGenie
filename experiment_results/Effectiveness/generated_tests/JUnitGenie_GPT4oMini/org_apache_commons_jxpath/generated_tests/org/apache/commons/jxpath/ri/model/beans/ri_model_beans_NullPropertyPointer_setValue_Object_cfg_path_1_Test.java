...
public class ri_model_beans_NullPropertyPointer_setValue_Object_cfg_path_1_Test {
    ...
    public void testSetValue_ThrowsJXPathInvalidAccessException_WhenParentIsNull() {
        ...
        try {
            ...
            // Expected exception
            String expectedMessage = "Cannot set property " + nullPropertyPointer.asPath() + ", the target object is null";
