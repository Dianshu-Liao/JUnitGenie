...
public class util_DefaultXmlPrettyPrinter_writeLeafElement_XMLStreamWriter2_String_String_int_cfg_path_1_Test {
    ...
    public void testWriteLeafElement() {
        ...
        // Mock the behavior of _objectIndenter to return false for isInline()
        ...
        try {
            ...
            Mockito.verify(mockWriter).writeInt(value);
