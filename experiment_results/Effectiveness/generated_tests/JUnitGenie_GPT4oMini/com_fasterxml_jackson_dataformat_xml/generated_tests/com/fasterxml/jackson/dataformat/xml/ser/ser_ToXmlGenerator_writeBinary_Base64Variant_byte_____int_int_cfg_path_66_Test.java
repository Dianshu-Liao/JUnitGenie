...
public class ser_ToXmlGenerator_writeBinary_Base64Variant_byte_____int_int_cfg_path_66_Test {
    ...
    @Test(timeout = 4000)
    public void testWriteBinaryThrowsXMLStreamException() throws XMLStreamException {
        byte[] data = new byte[]{1, 2, 3, 4, 5};
        int offset = 0;
        int len = data.length;
