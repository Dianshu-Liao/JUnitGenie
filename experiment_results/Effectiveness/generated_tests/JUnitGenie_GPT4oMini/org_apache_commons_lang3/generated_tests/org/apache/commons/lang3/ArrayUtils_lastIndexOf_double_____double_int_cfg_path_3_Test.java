...
public class ArrayUtils_lastIndexOf_double_____double_int_cfg_path_3_Test {
    ...
    public void testLastIndexOf_NegativeStartIndex() {
        ...
        int result = ArrayUtils.lastIndexOf(array, valueToFind, startIndex);
        assertEquals(INDEX_NOT_FOUND, result); // Should return INDEX_NOT_FOUND for negative start index
    }
