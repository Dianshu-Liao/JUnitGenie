...
public class ArrayUtils_insert_int_double_____double_____cfg_path_7_Test {
    ...
    public void testInsertWithEmptyValues() {
        ...
        double[] result = ArrayUtils.insert(1, array, new double[]{});
