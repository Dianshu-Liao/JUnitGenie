...
public class ArrayUtils_lastIndexOf_float_____float_int_cfg_path_5_Test {
    ...
    public void testLastIndexOf_ValueNotFound() {
        ...
        int result = ArrayUtils.lastIndexOf(array, valueToFind, startIndex);
        assertEquals(INDEX_NOT_FOUND, result); // Value not found, should return INDEX_NOT_FOUND
    }
    ...
    public void testLastIndexOf_NullArray() {
        ...
        try {
            int result = ArrayUtils.lastIndexOf(array, valueToFind, startIndex);
            assertEquals(INDEX_NOT_FOUND, result); // Null array, should return INDEX_NOT_FOUND
        } catch (Exception e) {
