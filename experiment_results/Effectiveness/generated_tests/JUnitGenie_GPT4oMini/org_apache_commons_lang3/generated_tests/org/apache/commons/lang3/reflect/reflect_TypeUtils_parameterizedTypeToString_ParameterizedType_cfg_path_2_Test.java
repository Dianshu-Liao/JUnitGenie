...
public class reflect_TypeUtils_parameterizedTypeToString_ParameterizedType_cfg_path_2_Test {
        ...
        try {
            ...
            ParameterizedType parameterizedType = new ParameterizedType() {
                ...
                public Type[] getActualTypeArguments() {
                    return new Type[]{String.class}; // Valid Type array
                }

                @Override
                public Type getRawType() {
                    return List.class; // Valid raw type
                }
