...
public class reflect_TypeUtils_mapTypeVariablesToArguments_Class_ParameterizedType_Map_cfg_path_3_Test {
    ...
    public void testMapTypeVariablesToArguments() {
        try {
            ...
            TypeVariable<Class<TestClass>> typeVar = cls.getTypeParameters()[0];
