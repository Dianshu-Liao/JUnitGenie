...
public class text_StrBuilder_appendSeparator_char_char_cfg_path_1_Test {
    ...
    public void testAppendSeparatorWithEmptyBuilder() {
        // Arrange
        StrBuilder strBuilder = new StrBuilder(); // Empty builder
        char standard = '-';
        char defaultIfEmpty = '*';
    ...
    @Test(timeout = 4000)
    public void testAppendSeparatorWithEmptyBuilderAndDefaultCharacter() {
        // Arrange
        StrBuilder strBuilder = new StrBuilder(); // Empty builder
        char standard = 'A';
        char defaultIfEmpty = 'B';
