...
public class text_ExtendedMessageFormat_equals_Object_cfg_path_3_Test {
    ...
    @Test(timeout = 4000)
    public void testEquals_SamePattern_DifferentRegistry() {
    ...
    @Test(timeout = 4000)
    public void testEquals_SamePattern_SameRegistry() {
