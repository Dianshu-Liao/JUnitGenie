...
public class ArrayUtils_indexesOf_float_____float_int_cfg_path_1_Test {
    ...
    @Test(timeout = 4000)
    public void testIndexesOfWithEmptyArray() {
        float[] array = {};
        float valueToFind = 2.0f;
        int startIndex = 0;
    ...
    @Test(timeout = 4000)
    public void testIndexesOfWithValueNotFound() {
