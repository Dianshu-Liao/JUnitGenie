...
public class DateTimeZone_forOffsetHoursMinutes_int_int_cfg_path_21_Test {
    ...
    public void testForOffsetHoursMinutes() {
        ...
        // Test case for valid negative offset
        zone = DateTimeZone.forOffsetHoursMinutes(-1, -30);
        assertNotNull(zone);
        
        // Test case for large offset
        try {
            DateTimeZone.forOffsetHoursMinutes(23, 59);
            assertNotNull(zone);
        } catch (IllegalArgumentException e) {
            fail("Did not expect IllegalArgumentException for valid large offset");
        }
    }
