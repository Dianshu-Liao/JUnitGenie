...
public class tz_ZoneInfoCompiler_main_String_____cfg_path_36_Test {
    ...
    @org.junit.Test
    public void testMainWithValidArgsAndSetFalse() {
        String[] args = {"-src", "inputDir", "-dst", "outputDir", "sourceFile1", "sourceFile2"};
        ZoneInfoLogger.set(false); // Setting the parameter to false
        try {
            ZoneInfoCompiler.main(args);
        } catch (Exception e) {
            // Handle the exception if it occurs
