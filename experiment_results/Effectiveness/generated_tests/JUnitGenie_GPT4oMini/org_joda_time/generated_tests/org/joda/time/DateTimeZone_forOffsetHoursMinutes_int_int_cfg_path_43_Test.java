...
public class DateTimeZone_forOffsetHoursMinutes_int_int_cfg_path_43_Test {

    @Test(timeout = 4000)
    public void testForOffsetHoursMinutes_throwsIllegalArgumentException_whenHoursOutOfRange() {
        try {
    ...
    @Test(timeout = 4000)
    public void testForOffsetHoursMinutes_throwsIllegalArgumentException_whenMinutesOutOfRange() {
        try {
    ...
    @Test(timeout = 4000)
    public void testForOffsetHoursMinutes_throwsIllegalArgumentException_whenPositiveHoursHaveNegativeMinutes() {
        try {
    ...
    @Test(timeout = 4000)
    public void testForOffsetHoursMinutes_throwsIllegalArgumentException_whenArithmeticExceptionOccurs() {
        try {
