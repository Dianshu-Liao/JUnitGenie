...
public class format_ISODateTimeFormat_dateByWeek_DateTimeFormatterBuilder_Collection_boolean_boolean_cfg_path_8_Test {
    ...
    public void testDateByWeek() {
        try {
            ...
            assertTrue("Expected reducedPrec to be false", !result);
