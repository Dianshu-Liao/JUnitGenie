...
public class Years_yearsBetween_ReadablePartial_ReadablePartial_cfg_path_2_Test {
    ...
    public void testYearsBetweenWithLocalDate() {
        ...
        LocalDate end = new LocalDate(2023, 1, 1);
    ...
    public void testYearsBetweenWithReadablePartial() {
        ...
        TestReadablePartial end = new TestReadablePartial(new LocalDate(2023, 1, 1));
        Years result = Years.yearsBetween(start, end);
        assertEquals(3, result.getYears());
    }

    @Test(timeout = 4000)
    public void testYearsBetweenWithDifferentTypes() {
        TestReadablePartial start = new TestReadablePartial(new LocalDate(2015, 5, 5));
        TestReadablePartial end = new TestReadablePartial(new LocalDate(2020, 5, 5));
        Years result = Years.yearsBetween(start, end);
