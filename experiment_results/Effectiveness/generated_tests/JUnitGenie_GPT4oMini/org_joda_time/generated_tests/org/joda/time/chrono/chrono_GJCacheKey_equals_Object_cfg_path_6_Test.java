...
public class chrono_GJCacheKey_equals_Object_cfg_path_6_Test {
    ...
    public void testEquals_DifferentCutoverInstant() {
        ...
        GJCacheKey key2 = new GJCacheKey(DateTimeZone.UTC, Instant.now().plus(1000), 5); // Changed to plus milliseconds
