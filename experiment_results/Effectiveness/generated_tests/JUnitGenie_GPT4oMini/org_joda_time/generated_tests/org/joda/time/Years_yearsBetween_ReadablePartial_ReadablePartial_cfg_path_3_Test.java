...
public class Years_yearsBetween_ReadablePartial_ReadablePartial_cfg_path_3_Test {
    ...
    public void testYearsBetween() {
        ...
        TestReadablePartial startPartial = new TestReadablePartial(start);
        TestReadablePartial endPartial = new TestReadablePartial(end);

        try {
            Years result = Years.yearsBetween(startPartial, endPartial);
