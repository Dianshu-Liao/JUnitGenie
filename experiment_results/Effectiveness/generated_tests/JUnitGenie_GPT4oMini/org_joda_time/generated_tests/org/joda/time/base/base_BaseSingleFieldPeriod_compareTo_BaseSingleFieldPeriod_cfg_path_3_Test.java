...
public class base_BaseSingleFieldPeriod_compareTo_BaseSingleFieldPeriod_cfg_path_3_Test {
    ...
    @Test(timeout = 4000)
    public void testCompareTo_SameClass_EqualValues() {
    ...
    @Test(timeout = 4000)
    public void testCompareTo_SameClass_FirstGreater() {
    ...
    @Test(timeout = 4000)
    public void testCompareTo_SameClass_FirstLess() {
        TestPeriod period1 = new TestPeriod(5);
