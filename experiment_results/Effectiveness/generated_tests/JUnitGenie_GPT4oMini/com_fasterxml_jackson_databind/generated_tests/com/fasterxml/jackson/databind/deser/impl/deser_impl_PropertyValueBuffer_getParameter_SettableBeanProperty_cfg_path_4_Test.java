...
public class deser_impl_PropertyValueBuffer_getParameter_SettableBeanProperty_cfg_path_4_Test {
    ...
    private class TestSettableBeanProperty extends SettableBeanProperty {
        ...
        @Override
        public SettableBeanProperty withValueDeserializer(JsonDeserializer<?> deserializer) { return null; }
