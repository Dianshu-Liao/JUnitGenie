...
public class deser_BasicDeserializerFactory_resolveMemberAndTypeAnnotations_DeserializationContext_AnnotatedMember_JavaType_cfg_path_23_Test {
    ...
    public void setUp() throws Exception {
        ...
        Constructor<?> ctxtConstructor = ctxtClass.getDeclaredConstructor(MapperConfig.class, JsonParser.class, Object.class, Object.class);
        ctxtConstructor.setAccessible(true);
        ctxt = (DeserializationContext) ctxtConstructor.newInstance(null, null, null, null);
