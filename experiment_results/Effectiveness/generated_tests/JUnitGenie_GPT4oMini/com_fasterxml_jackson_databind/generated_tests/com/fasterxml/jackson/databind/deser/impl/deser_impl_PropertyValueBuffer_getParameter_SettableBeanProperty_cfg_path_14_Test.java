...
public class deser_impl_PropertyValueBuffer_getParameter_SettableBeanProperty_cfg_path_14_Test {

    private static class TestSettableBeanProperty extends SettableBeanProperty {
        private final String propertyName;
        private final int creatorIndex;

        public TestSettableBeanProperty(String propertyName, int creatorIndex) {
            super(PropertyName.construct(propertyName), null, null, null);
