...
public class deser_std_StdDeserializer__checkFloatSpecialValue_String_cfg_path_8_Test {
    ...
    @Test(timeout = 4000)
    public void testCheckFloatSpecialValueWithEmptyString() {
        try {
            ...
            Float result = (Float) method.invoke(deserializer, "");
            assertNull(result);
        } catch (Exception e) {
            e.printStackTrace();
        }
