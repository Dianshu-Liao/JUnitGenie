...
public class deser_BasicDeserializerFactory_findValueInstantiator_DeserializationContext_BeanDescription_cfg_path_22_Test {
    ...
    public void setUp() throws Exception {
        ...
        ctxt = (DeserializationContext) ctxtConstructor.newInstance(factoryConfig);
        ...
        beanDesc = (BeanDescription) beanDescConstructor.newInstance(Object.class);

        // Create a DeserializerFactoryConfig instance
