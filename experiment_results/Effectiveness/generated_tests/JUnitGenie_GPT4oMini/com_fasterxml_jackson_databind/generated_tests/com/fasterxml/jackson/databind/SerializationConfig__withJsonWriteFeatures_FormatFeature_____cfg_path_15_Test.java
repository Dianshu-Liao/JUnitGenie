...
public class SerializationConfig__withJsonWriteFeatures_FormatFeature_____cfg_path_15_Test {
    ...
    public void test_withJsonWriteFeatures() {
        try {
            ...
            SerializationConfig config = (SerializationConfig) constructor.newInstance(new Object[]{}); // Pass an empty array for the constructor
