...
public class deser_BasicDeserializerFactory_resolveMemberAndTypeAnnotations_DeserializationContext_AnnotatedMember_JavaType_cfg_path_15_Test {
    ...
    public void setUp() throws Exception {
        ...
        Constructor<?> ctxtConstructor = ctxtClass.getDeclaredConstructor(AnnotationIntrospector.class, DeserializerFactoryConfig.class);
        ctxtConstructor.setAccessible(true);
        ctxt = (DeserializationContext) ctxtConstructor.newInstance(null, new DeserializerFactoryConfig());
        ...
        // Create an instance of BasicDeserializerFactory
