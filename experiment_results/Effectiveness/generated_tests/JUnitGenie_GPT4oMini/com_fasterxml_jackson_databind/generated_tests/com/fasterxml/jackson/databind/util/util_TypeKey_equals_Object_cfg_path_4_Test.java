...
public class util_TypeKey_equals_Object_cfg_path_4_Test {
    ...
    @Test(timeout = 4000)
    public void testEqualsWithSameTypedKeysDifferentType() {
        TypeKey key1 = new TypeKey(String.class, true);
        TypeKey key2 = new TypeKey(String.class, false);
        assertFalse(key1.equals(key2));
    }
