...
public class SerializationConfig__withJsonWriteFeatures_FormatFeature_____cfg_path_18_Test {
    ...
    public void test_withJsonWriteFeatures() {
        ...
        try {
            ...
            e.printStackTrace();
            fail("Exception thrown while invoking _withJsonWriteFeatures: " + e.getMessage());
        }
    }
    ...
    private SerializationConfig createSerializationConfig() {
        ...
        try {
            return (SerializationConfig) SerializationConfig.class.getDeclaredConstructors()[0]
                .newInstance();
        } catch (Exception e) {
            e.printStackTrace();
