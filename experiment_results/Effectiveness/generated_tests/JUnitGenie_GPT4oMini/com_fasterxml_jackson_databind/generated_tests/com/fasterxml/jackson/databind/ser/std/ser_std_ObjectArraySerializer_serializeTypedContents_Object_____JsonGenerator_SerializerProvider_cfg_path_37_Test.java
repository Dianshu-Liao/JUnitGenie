...
public class ser_std_ObjectArraySerializer_serializeTypedContents_Object_____JsonGenerator_SerializerProvider_cfg_path_37_Test {
    ...
    public void testSerializeTypedContents() {
        Object[] values = new Object[]{"test", 123, null}; // Test input
        try {
