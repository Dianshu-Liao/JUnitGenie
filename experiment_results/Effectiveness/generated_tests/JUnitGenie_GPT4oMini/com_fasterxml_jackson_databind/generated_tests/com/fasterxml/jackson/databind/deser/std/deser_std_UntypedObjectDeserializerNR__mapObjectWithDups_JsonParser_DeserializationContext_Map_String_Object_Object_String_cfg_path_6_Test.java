...
public class deser_std_UntypedObjectDeserializerNR__mapObjectWithDups_JsonParser_DeserializationContext_Map_String_Object_Object_String_cfg_path_6_Test {
    ...
    public void testMapObjectWithDups() {
        ...
        try {
            ...
            when(mockParser.getText()).thenReturn("newValue");
            ...
            assertTrue(((Map<?, ?>) result).containsKey(nextKey));
