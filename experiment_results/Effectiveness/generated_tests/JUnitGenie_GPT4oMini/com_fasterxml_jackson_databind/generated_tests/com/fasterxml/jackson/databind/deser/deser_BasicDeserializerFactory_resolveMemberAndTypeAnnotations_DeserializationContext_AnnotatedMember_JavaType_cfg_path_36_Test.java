...
public class deser_BasicDeserializerFactory_resolveMemberAndTypeAnnotations_DeserializationContext_AnnotatedMember_JavaType_cfg_path_36_Test {
    ...
    public void setUp() throws Exception {
        ...
        Constructor<?> ctxtConstructor = ctxtClass.getDeclaredConstructors()[0]; // Use the first constructor
        ...
        Constructor<?> memberConstructor = memberClass.getDeclaredConstructors()[0]; // Use the first constructor
