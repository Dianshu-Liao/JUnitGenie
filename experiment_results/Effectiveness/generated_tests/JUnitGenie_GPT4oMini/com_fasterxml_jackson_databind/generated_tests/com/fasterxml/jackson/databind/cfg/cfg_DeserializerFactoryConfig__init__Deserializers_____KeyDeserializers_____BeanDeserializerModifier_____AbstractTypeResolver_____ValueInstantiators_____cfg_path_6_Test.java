...
public class cfg_DeserializerFactoryConfig__init__Deserializers_____KeyDeserializers_____BeanDeserializerModifier_____AbstractTypeResolver_____ValueInstantiators_____cfg_path_6_Test {
    ...
    public void testConstructorWithParameters() {
        ...
        BeanDeserializerModifier[] modifiers = new BeanDeserializerModifier[0]; // Non-null
        AbstractTypeResolver[] atr = null; // This will trigger NO_ABSTRACT_TYPE_RESOLVERS
        ValueInstantiators[] vi = new ValueInstantiators[0]; // Non-null
