...
public class harmony_pack200_BHSDCodec_calculateSmallest__cfg_path_2_Test {
    ...
    public void testCalculateSmallestWhenDIsOneAndCardinalityIsLessThan4294967296() {
        try {
            ...
            cardinalityField.set(codec, 0L); // cardinality < 4294967296
    ...
    @Test(timeout = 4000)
    public void testCalculateSmallestWhenDIsOneAndCardinalityIsEqualTo4294967296() {
        try {
            // Arrange
            BHSDCodec codec = new BHSDCodec(1, 0); // d = 1
            // Use reflection to set the private field 'cardinality'
