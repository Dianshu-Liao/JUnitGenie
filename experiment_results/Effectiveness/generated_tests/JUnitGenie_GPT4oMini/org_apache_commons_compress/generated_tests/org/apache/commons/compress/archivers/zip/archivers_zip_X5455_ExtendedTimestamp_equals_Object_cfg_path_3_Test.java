...
public class archivers_zip_X5455_ExtendedTimestamp_equals_Object_cfg_path_3_Test {
    ...
    public void testEquals_DifferentModifyTime() {
        ...
        timestamp1.setFlags((byte) 0x07); // Same flags
        timestamp2.setFlags((byte) 0x07); // Same flags
        timestamp1.setModifyTime(new ZipLong(123456789L));
    ...
    public void testEquals_DifferentAccessTime() {
        ...
        timestamp1.setFlags((byte) 0x07); // Same flags
        timestamp2.setFlags((byte) 0x07); // Same flags
        timestamp1.setAccessTime(new ZipLong(123456789L));
        timestamp2.setAccessTime(new ZipLong(987654321L)); // Different access time
    ...
    public void testEquals_DifferentCreateTime() {
        ...
        timestamp1.setFlags((byte) 0x07); // Same flags
        timestamp2.setFlags((byte) 0x07); // Same flags
        timestamp1.setCreateTime(new ZipLong(123456789L));
        timestamp2.setCreateTime(new ZipLong(987654321L)); // Different create time
