...
public class compressors_lz4_BlockLZ4CompressorInputStream_initializeBackReference__cfg_path_3_Test {

    @Test(timeout = 4000)
    public void testInitializeBackReference_NoBackReference() {
        // Arrange
