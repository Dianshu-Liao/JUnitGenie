...
public class compressors_lzma_LZMAUtils_matches_byte_____int_cfg_path_3_Test {
    ...
    public void testMatchesWithInvalidSignature() {
        byte[] invalidSignature = { (byte) 0x5D, 0, 1 }; // Last byte is different
    ...
    public void testMatchesWithShortLength() {
        byte[] shortSignature = { (byte) 0x5D }; // Length is less than HEADER_MAGIC
