...
public class sym_ByteQuadsCanonicalizer__findSecondary_int_int_int_cfg_path_24_Test {
    ...
    public void testFindSecondary() {
        try {
            ...
            instance.getClass().getDeclaredField("_spilloverEnd").set(instance, 64); // Set to a value greater than _hashSize
            ...
            String result = (String) findSecondaryMethod.invoke(instance, 16, 1, 2);
