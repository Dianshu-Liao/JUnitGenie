...
public class Base64Variant_encode_byte_____boolean_cfg_path_5_Test {
    ...
    public void testBase64VariantInitialization() {
        ...
        Base64Variant base64Variant = new Base64Variant("test", "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", true, 'A', 76);
