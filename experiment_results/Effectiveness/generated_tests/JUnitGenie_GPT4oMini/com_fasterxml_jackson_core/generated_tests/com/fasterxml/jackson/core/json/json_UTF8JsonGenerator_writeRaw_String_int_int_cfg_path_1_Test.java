...
public class json_UTF8JsonGenerator_writeRaw_String_int_int_cfg_path_1_Test {
    ...
    public void testWriteRaw() {
        ...
        // The last parameter should be a char, so we provide a default character (e.g., '\0')
        UTF8JsonGenerator generator = new UTF8JsonGenerator(ioContext, 0, objectCodec, outputStream, '\0');
