...
public class sym_ByteQuadsCanonicalizer__findSecondary_int_int_int_____int_cfg_path_24_Test {
    ...
    public void testFindSecondary() {
        try {
            ...
            // This is just an example, you need to set these fields according to your test case
