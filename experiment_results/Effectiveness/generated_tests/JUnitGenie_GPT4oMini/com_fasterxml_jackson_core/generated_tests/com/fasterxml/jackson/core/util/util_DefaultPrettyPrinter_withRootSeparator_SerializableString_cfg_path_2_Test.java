...
public class util_DefaultPrettyPrinter_withRootSeparator_SerializableString_cfg_path_2_Test {
    ...
    public void testWithRootSeparator() {
        ...
        SerializableString rootSeparator = new TestSerializableString("rootSeparator");
        
        // Simulating the _rootSeparator being null
        try {
