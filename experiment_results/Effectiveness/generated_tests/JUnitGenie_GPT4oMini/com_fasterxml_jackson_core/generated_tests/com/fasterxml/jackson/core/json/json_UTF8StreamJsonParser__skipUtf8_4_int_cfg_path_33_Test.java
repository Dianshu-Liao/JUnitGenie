...
public class json_UTF8StreamJsonParser__skipUtf8_4_int_cfg_path_33_Test {
    ...
    public void setUp() throws Exception {
        ...
        parser = new UTF8StreamJsonParser(ioContext, 0, new ByteArrayInputStream(inputBuffer), codec, canonicalizer, inputBuffer, 0, inputBuffer.length, false);
    }
