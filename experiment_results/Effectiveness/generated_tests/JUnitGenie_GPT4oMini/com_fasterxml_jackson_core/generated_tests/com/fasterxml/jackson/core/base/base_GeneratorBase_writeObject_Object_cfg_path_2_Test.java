...
public class base_GeneratorBase_writeObject_Object_cfg_path_2_Test {
    ...
    private class TestGenerator extends GeneratorBase {
        ...
        @Override
        public void writeBinary(com.fasterxml.jackson.core.Base64Variant variant, byte[] data, int offset, int length) throws IOException {
            // Implementation not needed for this test
        }
