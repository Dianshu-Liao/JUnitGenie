...
public class Base64Variant_encode_byte_____boolean_cfg_path_18_Test {
    ...
    public void testEncodeWithoutQuotes() {
        // Arrange
        Base64Variant base64Variant = new Base64Variant("test", "test", false, 'A', 76);
        byte[] input = {1, 2, 3, 4, 5};
    ...
    public void testEncodeWithSingleByteInput() {
        ...
        // Assert
        String expected = "\"AQ==\""; // Expected output for single byte input
        assertEquals(expected, result);
    }
    ...
    public void testEncodeWithTwoBytesInput() {
        ...
        // Assert
        String expected = "\"AQI=\""; // Expected output for two bytes input
        assertEquals(expected, result);
    }
    ...
    public void testBase64VariantInitialization() {
        ...
        // when the Base64 alphabet length is not 64.
