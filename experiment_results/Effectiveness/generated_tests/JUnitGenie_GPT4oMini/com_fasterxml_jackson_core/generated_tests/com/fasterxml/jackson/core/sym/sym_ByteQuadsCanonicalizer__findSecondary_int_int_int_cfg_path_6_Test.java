...
public class sym_ByteQuadsCanonicalizer__findSecondary_int_int_int_cfg_path_6_Test {
    ...
    public void testFindSecondary() {
        try {
            ...
            Constructor<?> constructor = clazz.getDeclaredConstructor(int.class, int.class, boolean.class); // Updated to use Constructor
            constructor.setAccessible(true);
            ByteQuadsCanonicalizer instance = (ByteQuadsCanonicalizer) constructor.newInstance(16, 16, false); // Added boolean argument
            ...
            String result = (String) findSecondaryMethod.invoke(instance, 8, 1, 2);
