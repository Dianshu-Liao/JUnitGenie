...
public class Base64Variants_valueOf_String_cfg_path_2_Test {
    ...
    public void testValueOf_MIME() {
        try {
            ...
            fail("Should not have thrown IllegalArgumentException for valid name 'MIME'");
        }
    }
    ...
    public void testValueOf_MIME_NO_LINEFEEDS() {
        try {
            ...
            fail("Should not have thrown IllegalArgumentException for valid name 'MIME_NO_LINEFEEDS'");
        }
    }
    ...
    public void testValueOf_PEM() {
        try {
            ...
            fail("Should not have thrown IllegalArgumentException for valid name 'PEM'");
        }
    }
    ...
    public void testValueOf_MODIFIED_FOR_URL() {
        try {
            ...
            fail("Should not have thrown IllegalArgumentException for valid name 'MODIFIED_FOR_URL'");
        }
    }
