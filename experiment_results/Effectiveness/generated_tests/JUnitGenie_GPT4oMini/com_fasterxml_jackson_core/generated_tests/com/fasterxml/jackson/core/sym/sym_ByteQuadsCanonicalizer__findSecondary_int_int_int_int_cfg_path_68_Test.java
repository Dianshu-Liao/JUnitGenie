...
public class sym_ByteQuadsCanonicalizer__findSecondary_int_int_int_int_cfg_path_68_Test {
    ...
    public void testFindSecondary() {
        try {
            ...
            setField(instance, "_spilloverEnd", 56);
            setField(instance, "_hashSize", 8); // Ensure this._hashSize <= this._spilloverEnd / 7
