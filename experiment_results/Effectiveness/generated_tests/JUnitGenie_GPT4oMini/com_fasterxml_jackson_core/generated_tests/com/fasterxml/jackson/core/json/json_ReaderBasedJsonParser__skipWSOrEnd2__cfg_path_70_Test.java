...
public class json_ReaderBasedJsonParser__skipWSOrEnd2__cfg_path_70_Test {
    ...
    public void testSkipWSOrEnd2() {
        ...
        ReaderBasedJsonParser parser = new ReaderBasedJsonParser(ioContext, 0, new StringReader(new String(inputBuffer)), null, CharsToNameCanonicalizer.createRoot(), inputBuffer, 0, inputBuffer.length, false);
