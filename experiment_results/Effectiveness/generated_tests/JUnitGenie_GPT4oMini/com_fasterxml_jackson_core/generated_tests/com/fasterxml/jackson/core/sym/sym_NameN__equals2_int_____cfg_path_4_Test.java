...
public class sym_NameN__equals2_int_____cfg_path_4_Test {

    @Test(timeout = 4000)
    public void testEquals2() {
        try {
            // Create an instance of NameN using the constructor
            NameN nameN = new NameN("test", 1, 2, 3, 4, 5, new int[]{1, 2, 3, 4, 5, 6}, 6);
            ...
            int[] quads = new int[]{1, 2, 3, 4, 5, 6}; // This should match the internal state of NameN
