...
public class ArrayUtils_swap_341_0_Test {
    ...
    public void testSwap_ValidIndices() {
        ...
        ArrayUtils.swap(array, 1, 3, 1);
        assertArrayEquals(new Object[] { 1, 4, 3, 2, 5 }, array);
    }

    @Test
    public void testSwap_ValidIndices_MultipleElements() {
        Object[] array = { 1, 2, 3, 4, 5 };
    ...
    public void testSwap_OffsetOutOfBounds() {
        Object[] array = { 1, 2, 3, 4, 5 };
        ArrayUtils.swap(array, 1, 5, 1);
        assertArrayEquals(new Object[] { 1, 2, 3, 4, 5 }, array);
    }

    @Test
    public void testSwap_NegativeOffset() {
        Object[] array = { 1, 2, 3, 4, 5 };
        ArrayUtils.swap(array, -1, 2, 1);
        assertArrayEquals(new Object[] { 1, 2, 3, 4, 5 }, array);
    }
    ...
    public void testSwap_SingleElementArray() {
        Object[] array = { 1 };
        ArrayUtils.swap(array, 0, 0, 1);
        assertArrayEquals(new Object[] { 1 }, array);
    }

    @Test
    public void testSwap_IndicesEqual() {
        Object[] array = { 1, 2, 3, 4, 5 };
        ArrayUtils.swap(array, 2, 2, 1);
        assertArrayEquals(new Object[] { 1, 2, 3, 4, 5 }, array);
    }

    @Test
    public void testSwap_LenExceedsArrayLength() {
        Object[] array = { 1, 2, 3 };
        ArrayUtils.swap(array, 0, 1, 5);
