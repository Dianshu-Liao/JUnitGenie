...
public class ArrayUtils_swap_340_2_Test {
    ...
    @Test
    public void testSwap_OutOfBoundsIndices() {
        Object[] array = { 1, 2, 3, 4, 5 };
        ArrayUtils.swap(array, -1, 5);
        assertArrayEquals(new Object[] { 1, 2, 3, 4, 5 }, array);
    }

    @Test
    public void testSwap_FirstIndexOutOfBounds() {
        Object[] array = { 1, 2, 3, 4, 5 };
        ArrayUtils.swap(array, 5, 1);
        assertArrayEquals(new Object[] { 1, 2, 3, 4, 5 }, array);
    }

    @Test
    public void testSwap_SecondIndexOutOfBounds() {
        Object[] array = { 1, 2, 3, 4, 5 };
        ArrayUtils.swap(array, 1, 5);
        assertArrayEquals(new Object[] { 1, 2, 3, 4, 5 }, array);
    }
    ...
    @Test
    public void testSwap_NegativeIndices() {
        Object[] array = { 1, 2, 3, 4, 5 };
