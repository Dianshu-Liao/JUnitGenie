...
public class StringUtils_center_10_0_Test {
    ...
    @Test
    public void testCenter_EmptyPadString() {
    ...
    @Test
    public void testCenter_SizeLessThanStringLength() {
        String result = StringUtils.center("test", 3, "*");
        assertEquals("test", result);
    }

    @Test
    public void testCenter_OddSizeWithCustomPadString() {
        String result = StringUtils.center("test", 11, "*#");
        assertEquals("*#*#*test*#*#", result);
    }

    @Test
    public void testCenter_EvenSizeWithCustomPadString() {
        String result = StringUtils.center("test", 12, "*#");
        assertEquals("*#*#*test*#*#*", result);
    }

    @Test
    public void testCenter_SpaceAsPadString() {
        String result = StringUtils.center("test", 10, " ");
        assertEquals("   test    ", result);
    }
    ...
    @Test
    public void testCenter_SingleCharacterPadString() {
        String result = StringUtils.center("test", 10, "#");
        assertEquals("###test###", result);
    }

    @Test
    public void testCenter_LargeSizeWithSingleCharacterPad() {
